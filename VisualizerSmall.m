function mean_compsize_P=Visualizer(vaccine_vector, adjacency_mat, threshold, transcendence)
    ...
    h=plot(H1,'layout','force','MarkerSize',5,'NodeLabel',{},'NodeColor','k',...
    ...
    highlight(h,node_remove,'NodeColor','r','MarkerSize',3);
    highlight(h,vaccine_vector,'NodeColor','b','MarkerSize',8);
